...
#define JOB_DISPLAY_ORDER_F13TOWNDOCTOR 116
...
GLOBAL_LIST_INIT(faction_list, list(FACTION_NCR, FACTION_LEGION, FACTION_BROTHERHOOD, FACTION_KEBAB, FACTION_ENCLAVE, FACTION_WASTELAND, FACTION_RAIDERS))
